...
$this->db->where(array('receiver_id' => 1, 'sender_id' => $reciever, 
))->update('notifications', array('readed' => 1));
...
$message='Hi ';
 ...
 $conversation_id= $this->db->insert_id();
                $arr['redirect'] = 'chat/messages/'.$sender_id.'/'.$rec_id.'/'.$cl[0]->conversation_id;
...
$arr['redirect'] = 'chat/messages/'.$sender_id.'/'.$rec_id.'/'.$cl;
