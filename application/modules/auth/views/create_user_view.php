...
<div class="content-wrapper">
    <section class="content-header">
		...
		if($user_type==3){
			$redirect='view_users';	
			}elseif($user_type==2){$redirect='agent';	
			}else{
				$redirect='view-admin';	
				}
                   ...
                   <div class="col-xs-12 col-md-4 ">
                    ...
                    <div class="col-xs-12 col-md-4 ">
                        <label> <?php echo ucwords(this_lang('Contact')); ?></label>
                            <input type="text" id="phone" name="phone" value="<?php if(isset($row)){ echo $row->phone;} ?>" class="form-control col-md-3" placeholder="phone">
                        </div>
                   
                        <!--<div class="col-md-6 col-xs-12 ">
                             <label> <?php echo ucwords(this_lang('Mobile')); ?> </label>
                            <input type="text" id="mobile" name="mobile" class="form-control col-md-3" value="<?php if(isset($row)){ echo $row->mobile;} ?>" placeholder="0341 1234567">
                        </div>-->
                        </div>
