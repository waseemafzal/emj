...
class Commodity_types extends MX_Controller {
	...
	public $view = "view-commodity-types";
	/************Configuration of form and dataTable*********************/
	public $tbl = 'commodity_types';
	
	public $module_heading='Commodity Types Management'; 
	...
	public function add(){  
		...
		$aData['module_heading'] =$this->module_heading;
	//	pre($aData);
		$this->load->view('add-commodity-type',$aData);
	}
