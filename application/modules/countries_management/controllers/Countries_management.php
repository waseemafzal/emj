...
class Countries_management extends MX_Controller {
	...
	public $module_heading='Countries Management'; 
	...
	function save(){ 
		...
		$this->form_validation->set_rules('sortname', 'sortname', 'trim|required');
