...
<section class="content-header">
      ...
      <ol class="breadcrumb">
        <li > <a href="<?=$controller?>/add?state_id=<?=$_GET['state_id'];?>" class="btn btn-sm btn-success txt-white"><i class="fa fa-plus icon-white"></i> Add New Record</a></li>
      </ol>
    </section>
    <!-- Main content -->
    ...
    <td class="center">
           ...
           <a data-toggle="tooltip" title=" <?php echo ucwords(this_lang('Edit'));?>" class="btn btn-info btn-xs" href="<?=$controller?>/edit?id=<?php echo $row->id;?>&state_id=<?=$_GET['state_id'];?>">
