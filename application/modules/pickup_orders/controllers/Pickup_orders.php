...
class Pickup_orders extends MX_Controller {
	...
	public $view = "view_pickup_orders";
	/************Configuration of form and dataTable*********************/
	public $tbl = 'pickup_orders';
	
	public $module_heading='Pickup Orders Management'; 
	...
	public function add(){  
		...
		$aData['module_heading'] =$this->module_heading;
	//	pre($aData);
		$this->load->view('add_pickup_order',$aData);
	}
