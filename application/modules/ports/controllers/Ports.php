...
class Ports extends MX_Controller {
	...
	public $view = "view-ports";
	/************Configuration of form and dataTable*********************/
	public $tbl = 'ports';
	
	public $module_heading='Ports Management'; 
...
//echo 'out o if';exit;
	...
	//pre();
		//pre($_POST);
		$_POST['transportation_method'] = implode(',', $_POST['transportation_method']);
