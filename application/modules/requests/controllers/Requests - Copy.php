...
class Requests extends MX_Controller {
	...
	public $tbl = 'requests';
	public $tableColmns=array('name','price','interval','description'); // DB colmn you wish to show in list
	...
	public function index(){  
		...
		$aData['data'] =$this->db->query("SELECT r.*,u.name,u.image FROM `requests` as r 
