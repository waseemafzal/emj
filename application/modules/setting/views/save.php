...
background-color: #fff;
 ...
 #legalSesction{
                   background-color: #cccccc0f;width: auto;float: left;padding: 0 0 25px 0;border: 1px solid;margin: 10px 0 0 10px;border-radius: 5px;
                   }
   </style>
...
<textarea class="form-control"  name="share_message"><?php if(isset($row)){ echo $row->share_message;} ?></textarea>
                   ...
                   <div class="col-md-12"><h4>Social Settings</h4></div>
                   </hr>
