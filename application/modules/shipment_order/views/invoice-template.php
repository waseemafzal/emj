    ...
    <section class="invoice">
      ...
      <div class="invoice-info" style="position:relative">
        ...
        <h2 class="page-header">
            ...
            <div class=''style='width: 25%;float: left;display: inline-block;margin-bottom:20px'>
          From
        ...
        <!-- /.col -->
<div class=''style='width: 25;float:right;display: inline-block;margin-right:50px'>
