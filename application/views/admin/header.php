		 ...
		 ?>
          <li class="dropdown messages-menu">
            ...
            <ul class="dropdown-menu">
              <li class="header">You have <?=count($notifications)?> messages</li>
			  ...
			  if(count($notifications)>0){
				...
				$body=  ucfirst($notification['body']);
				$dateTime = time_elapsed_string($notification['created_date']);
				$sender_id = $notification['sender_id'];
				$receiver_id = $notification['receiver_id'];
				$userImage = setImage($notification['image']);
				$userName =$notification['name'];
			  ?>
                <!-- start message -->
                  <li>
                    <a href="<?=base_url()?>chat/messages/1/<?=$sender_id?>/<?=$receiver_id?>">
                      <div class="pull-left">
                        <img src="<?=$userImage?>" class="img-circle" alt="<?=$userName?>">
                      </div>
                      <h4>
                        <?=$userName?>
              ...
              <li class="footer"><a href="<?php echo base_url();?>chat/getConversations">See All Messages</a></li>
            </ul>
          </li>
