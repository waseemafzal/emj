...
<head>
    ...
    <link rel="apple-touch-icon" sizes="180x180" href="assets_chat/apple-touch-icon.png">

    <link rel="icon" type="image/png" sizes="32x32" href="assets_chat/favicon-32x32.png">

    <link rel="icon" type="image/png" sizes="16x16" href="assets_chat/favicon-16x16.png">
    ...
    <link rel="stylesheet" href="assets_chat/webfonts/inter/inter.css">

    <link rel="stylesheet" href="assets_chat/css/app.min.css">
    <style>
        ...
        div.chat-header-conversation{
            background-color:#d73925 !important;
        }
        div.self div.message-content{
            background-color:#d73925 !important;
...
<body class="chats-tab-open">
    ...
    <div class="main-layout">
            ...
            <ul class="nav nav-minimal flex-row flex-grow-1 justify-content-between flex-xl-column justify-content-xl-center" id="mainNavTab" role="tablist">
                ...
                <li class="nav-item">
                    ...
                    <a class="nav-link p-0 py-xl-3 active" id="chats-tab" href="#chats-content" title="Chats">
                        ...
                        <!-- <img class="injectable hw-24" src="./assets_chat/media/heroicons/outline/chat-alt-2.svg" alt="Chat icon"> -->
                ...
                <li class="nav-item">
                    ...
                    <a class="nav-link p-0 py-xl-3 " id="calls-tab" href="#calls-content" title="Calls">
                        ...
                        <!-- <img class="injectable hw-24" src="./assets_chat/media/heroicons/outline/phone.svg" alt="Phone icon"> -->
                ...
                <li class="nav-item">
                    ...
                    <a class="nav-link p-0 py-xl-3" id="friends-tab" href="#friends-content" title="Friends">
                        ...
                        <!-- <img class="injectable hw-24" src="./assets_chat/media/heroicons/outline/users.svg" alt="Friends icon"> -->
                ...
                <li class="nav-item">
                    ...
                    <a class="nav-link p-0 py-xl-3" id="profile-tab" href="#profile-content" title="Profile">
                        ...
                        <!-- <img class="injectable hw-24" src="./assets_chat/media/heroicons/outline/user-circle.svg" alt="Profile icon"> -->
                ...
                <div class="tab-pane active" id="chats-content">
                    ...
                    <div class="d-flex flex-column h-100">
                        ...
                        <div class="hide-scrollbar h-100" id="chatContactsList">
                            ...
                            <div class="sidebar-header sticky-top p-2 chat-header-conversation py-3">
                                ...
                                <div style="display: none;" class="sidebar-sub-header">
                            ...
                            <ul class="contacts-list" id="chatContactTab" data-chat-list="">
                                ...
                                if (isset($chat_between) && !empty($chat_between)) {
                                ...
                                foreach ($conversations as $val) {
                                    ...
                                    if ($reciever == $val->receiver_id && $owner == $val->owner_id) {

                                        $user_data = $val;
                                    }
                                    // $check_user .= 'reciever_id:' . $user_data->receiver_id . '=matching:' . $val->receiver_id . '<br>';
                                    if ($user_data->receiver_id == $val->receiver_id) {
                                        // $check_user += 1;
                                        $my_color = 'background-color:#dcdcdca3';
                                    }
                                    ...
                                    if ($val->UnreadCount > 0) {
                                        ...
                                        $unread_msg = '<div class="badge badge-rounded badge-primary ml-1">' . $val->UnreadCount . '</div>';
                                    }
                                ...
                                ?>
                                    ...
                                    <li style="<?php echo $my_color; ?>" class="contacts-item friends">

                                        <a class="contacts-link" href="<?php echo base_url() . 'chat/messages/' . $val->owner_id . '/' . $val->receiver_id . '/' . $val->conversation_id; ?>">



                                            <div class="avatar <?php echo $status; ?>">

                                                <img src="<?php echo $val->avatar_receiver;  ?>" alt="">
                                            ...
                                            <div class="contacts-content">
                                                ...
                                                <div class="contacts-info">
                                                    ...
                                                    <h6 class="chat-name text-truncate"><?php echo $val->name_receiver; ?></h6>

                                                    <div class="chat-time"><?php echo $val->date; ?></div>
                                                ...
                                                <div class="contacts-texts">
                                                    ...
                                                    <p <?php echo $style; ?> class="text-truncate"><?php echo $val->message; ?></p>
                                    ...
                                    <ul class="nav flex-nowrap">
                                        ...
                                        <li class="nav-item list-inline-item mr-1">
                                            ...
                                            <a class="nav-link text-muted px-1" href="#" title="Notifications" role="button" data-toggle="modal" data-target="#notificationModal">
                                                ...
                                                <!-- <img src="./assets_chat/media/heroicons/outline/bell.svg" alt="" class="injectable hw-20"> -->
                                        ...
                                        <li class="nav-item list-inline-item mr-0">
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <a class="nav-link text-muted px-1" href="#" role="button" title="Details" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                    ...
                                                    <!-- <img src="./assets_chat/media/heroicons/outline/dots-vertical.svg" alt="" class="injectable hw-20"> -->
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="input-group-append">
                                                ...
                                                <div class="input-group-text transparent-bg border-left-0" role="button">
                                                    ...
                                                    <!-- <img class="injectable hw-20" src="./assets_chat/media/heroicons/outline/search.svg" alt=""> -->
                                ...
                                <li class="contacts-item incoming active">
                                    ...
                                    <div class="contacts-link">
                                        ...
                                        <div class="avatar">
                                            ...
                                            <img src="assets_chat/media/avatar/2.png" alt="">
                                        ...
                                        <div class="contacts-content">
                                            ...
                                            <div class="contacts-texts">
                                                ...
                                                <!-- <img class="injectable hw-16 text-muted mr-1" src="./assets_chat/media/heroicons/solid/phone-incoming.svg" alt=""> -->
                                        ...
                                        <div class="contacts-action">
                                            ...
                                            <button class="btn btn-secondary btn-icon btn-minimal btn-sm text-muted" type="button">
                                                ...
                                                <!-- <img class="injectable hw-20" src="./assets_chat/media/heroicons/outline/phone.svg" alt=""> -->
                                    ...
                                    <div class="contacts-link outgoing">
                                        ...
                                        <div class="contacts-content">
                                            ...
                                            <div class="contacts-texts">
                                                ...
                                                <!-- <img class="injectable hw-16 text-muted mr-1" src="./assets_chat/media/heroicons/solid/phone-outgoing.svg" alt=""> -->
                                ...
                                <li class="contacts-item missed">
                                    ...
                                    <div class="contacts-link missed">
                                        ...
                                        <div class="avatar">
                                            ...
                                            <img src="assets_chat/media/avatar/3.png" alt="">
                                        ...
                                        <div class="contacts-content">
                                            ...
                                            <div class="contacts-texts">
                                                ...
                                                <!-- <img class="injectable hw-16 text-danger mr-1" src="./assets_chat/media/heroicons/solid/phone-incoming.svg" alt=""> -->
                                ...
                                <li class="contacts-item outgoing">
                                    ...
                                    <div class="contacts-link outgoing">
                                        ...
                                        <div class="avatar">
                                            ...
                                            <img src="assets_chat/media/avatar/4.png" alt="">
                                ...
                                <li class="contacts-item incoming">
                                    ...
                                    <div class="contacts-link incoming">
                                        ...
                                        <div class="avatar">
                                            ...
                                            <img src="assets_chat/media/avatar/5.png" alt="">
                                ...
                                <li class="contacts-item incoming">
                                    ...
                                    <div class="contacts-link incoming">
                                        ...
                                        <div class="avatar">
                                            ...
                                            <img src="assets_chat/media/avatar/6.png" alt="">
                                ...
                                <li class="contacts-item outgoing">
                                    ...
                                    <div class="contacts-link outgoing">
                                        ...
                                        <div class="avatar">
                                            ...
                                            <img src="assets_chat/media/avatar/7.png" alt="">
                                    ...
                                    <a class="contacts-link" href="#">
                                        ...
                                        <div class="contacts-content">
                                            ...
                                            <div class="contacts-texts">
                                                ...
                                                <!-- <img class="injectable hw-16 text-muted mr-1" src="./assets_chat/media/heroicons/solid/location-marker.svg" alt=""> -->
                                        ...
                                        <div class="card card-body card-bg-5">
                                            ...
                                            <div class="d-flex flex-column align-items-center">
                                                ...
                                                <div class="avatar avatar-lg mb-3">
                                                    ...
                                                    <img class="avatar-img" src="assets_chat/media/avatar/3.png" alt="">
                                                ...
                                                <div class="d-flex">
                                                    ...
                                                    <button class="btn btn-outline-default mx-1" type="button">
                                                        ...
                                                        <!-- <img class="injectable hw-18 d-sm-inline-block" src="./assets_chat/media/heroicons/outline/logout.svg" alt=""> -->
                                                    ...
                                                    <button class="btn btn-outline-default mx-1 d-xl-none" data-profile-edit="" type="button">
                                                        ...
                                                        <!-- <img class="injectable hw-18 d-sm-inline-block" src="./assets_chat/media/heroicons/outline/cog.svg" alt=""> -->
                                            ...
                                            <div class="card-options">
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <button class="btn btn-secondary btn-icon btn-minimal btn-sm text-muted text-muted" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                        ...
                                                        <!-- <img class="injectable hw-20" src="./assets_chat/media/heroicons/outline/dots-vertical.svg" alt=""> -->
                                            ...
                                            <ul class="list-group list-group-flush">
                                                ...
                                                <li class="list-group-item py-2">
                                                    ...
                                                    <div class="media align-items-center">
                                                        ...
                                                        <!-- <img class="injectable text-muted hw-20 ml-1" src="./assets_chat/media/heroicons/outline/clock.svg" alt=""> -->
                                                ...
                                                <li class="list-group-item py-2">
                                                    ...
                                                    <div class="media align-items-center">
                                                        ...
                                                        <!-- <img class="injectable text-muted hw-20 ml-1" src="./assets_chat/media/heroicons/outline/calendar.svg" alt=""> -->
                                                ...
                                                <li class="list-group-item py-2">
                                                    ...
                                                    <div class="media align-items-center">
                                                        ...
                                                        <!-- <img class="injectable text-muted hw-20 ml-1" src="./assets_chat/media/heroicons/outline/phone.svg" alt=""> -->
                                                ...
                                                <li class="list-group-item py-2">
                                                    ...
                                                    <div class="media align-items-center">
                                                        ...
                                                        <!-- <img class="injectable text-muted hw-20 ml-1" src="./assets_chat/media/heroicons/outline/mail.svg" alt=""> -->
                                                ...
                                                <li class="list-group-item py-2">
                                                    ...
                                                    <div class="media align-items-center">
                                                        ...
                                                        <!-- <img class="injectable text-muted hw-20 ml-1" src="./assets_chat/media/heroicons/outline/globe.svg" alt=""> -->
                                                ...
                                                <li class="list-group-item pt-2">
                                                    ...
                                                    <div class="media align-items-center">
                                                        ...
                                                        <!-- <img class="injectable text-muted hw-20 ml-1" src="./assets_chat/media/heroicons/outline/home.svg" alt=""> -->
                                            ...
                                            <ul class="list-group list-group-flush">
                                                ...
                                                <li class="list-group-item py-2">
                                                    ...
                                                    <div class="media align-items-center">
                                                        ...
                                                        <!-- <img class="injectable text-muted hw-20 ml-1" src="./assets_chat/media/icons/facebook.svg" alt=""> -->
                                                ...
                                                <li class="list-group-item py-2">
                                                    ...
                                                    <div class="media align-items-center">
                                                        ...
                                                        <!-- <img class="injectable text-muted hw-20 ml-1" src="./assets_chat/media/icons/twitter.svg" alt=""> -->
                                                ...
                                                <li class="list-group-item py-2">
                                                    ...
                                                    <div class="media align-items-center">
                                                        ...
                                                        <!-- <img class="injectable text-muted hw-20 ml-1" src="./assets_chat/media/icons/instagram.svg" alt=""> -->
                                                ...
                                                <li class="list-group-item py-2">
                                                    ...
                                                    <div class="media align-items-center">
                                                        ...
                                                        <!-- <img class="injectable text-muted hw-20 ml-1" src="./assets_chat/media/icons/linkedin.svg" alt=""> -->
                ...
                <div class="chat-body">
                    ...
                    <div class="chat-header">
                        ...
                        <button class="btn btn-secondary btn-icon btn-minimal btn-sm text-muted d-xl-none" type="button" data-close="">
                            ...
                            <!-- <img class="injectable hw-20" src="./assets_chat/media/heroicons/outline/arrow-left.svg" alt=""> -->
                        ...
                        <div class="media chat-name align-items-center text-truncate">
                            ...
                            <div class="avatar avatar-online d-none d-sm-inline-block mr-3">
                                ...
                                <img src="<?php echo $user_data->avatar_receiver; ?>" alt="">



                                <!-- haris -->

                                <input type="hidden" id="receiver_id" value="<?php echo $user_data->receiver_id; ?>">

                                <input type="hidden" id="owner_id" value="<?php echo $user_data->owner_id; ?>">
                            ...
                            <div class="media-body align-self-center ">
                                ...
                                <h6 class="text-truncate mb-0"><?php echo $user_data->name_receiver; ?></h6>
                        ...
                        <ul style="display: none;" class="nav flex-nowrap">
                            ...
                            <li class="nav-item list-inline-item d-none d-sm-block mr-1">
                                ...
                                <a class="nav-link text-muted px-1" data-toggle="collapse" data-target="#searchCollapse" href="#" aria-expanded="false">
                                    ...
                                    <!-- <img src="./assets_chat/media/heroicons/outline/search.svg" alt="" class="injectable hw-20"> -->
                            ...
                            <li class="nav-item list-inline-item d-none d-sm-block mr-1">
                                ...
                                <a class="nav-link text-muted px-1" href="#" title="Add People">
                                    ...
                                    <!-- <img src="./assets_chat/media/heroicons/outline/phone.svg" alt="" class="injectable hw-20"> -->
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <a class="dropdown-item align-items-center d-flex" href="#" data-chat-info-toggle="">
                                            ...
                                            <!-- <img src="./assets_chat/media/heroicons/outline/information-circle.svg" alt="" class="injectable hw-20 mr-2"> -->
                                        ...
                                        <a class="dropdown-item align-items-center d-flex" href="#">
                                            ...
                                            <!-- <img src="./assets_chat/media/heroicons/outline/volume-off.svg" alt="" class="injectable hw-20 mr-2"> -->
                                        ...
                                        <a class="dropdown-item align-items-center d-flex" href="#">
                                            ...
                                            <!-- <img src="./assets_chat/media/heroicons/outline/photograph.svg" alt="" class="injectable hw-20 mr-2"> -->
                                        ...
                                        <a class="dropdown-item align-items-center d-flex" href="#">
                                            ...
                                            <!-- <img src="./assets_chat/media/heroicons/outline/archive.svg" alt="" class="injectable hw-20 mr-2"> -->
                                        ...
                                        <a class="dropdown-item align-items-center d-flex" href="#">
                                            ...
                                            <!-- <img src="./assets_chat/media/heroicons/outline/trash.svg" alt="" class="injectable hw-20 mr-2"> -->
                                        ...
                                        <a class="dropdown-item align-items-center d-flex text-danger" href="#">
                                            ...
                                            <!-- <img src="./assets_chat/media/heroicons/outline/ban.svg" alt="" class="injectable hw-20 mr-2"> -->
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <a class="dropdown-item align-items-center d-flex" href="#">
                                            ...
                                            <!-- <img src="./assets_chat/media/heroicons/outline/phone.svg" alt="" class="injectable hw-20 mr-2"> -->
                                        ...
                                        <a class="dropdown-item align-items-center d-flex" href="#" data-toggle="collapse" data-target="#searchCollapse" aria-expanded="false">
                                            ...
                                            <!-- <img src="./assets_chat/media/heroicons/outline/search.svg" alt="" class="injectable hw-20 mr-2"> -->
                            ...
                            <div class="input-group bg-light ">
                                ...
                                <div class="input-group-append">
                                    ...
                                    <span class="input-group-text transparent-bg border-left-0">
                                        ...
                                        <!-- <img class="injectable hw-20" src="./assets_chat/media/heroicons/outline/search.svg" alt="Search icon"> -->
                                    ...
                                    ?>
                                        ...
                                        <div class="message">
                                            ...
                                            <div class="message-options">
                                                ...
                                                <div class="avatar avatar-sm"><img alt="" src="<?php echo $user_data->avatar_receiver; ?>"></div>

                                                <span class="message-date"><?php echo $chat['date']; ?></span>
                                    ...
                                    <?php } else { ?>
                                        ...
                                        <div class="message self">
                                            ...
                                            <div class="message-options">
                                                ...
                                                <div class="avatar avatar-sm"><img alt="" src="<?php echo $user_data->avatar_owner; ?>"></div>



                                                <small> <span class="message-date"><?php echo $chat['date']; ?></span></small>


                                                <small class="del_msg_icon">
                                                    <a class="text-danger p-0" href="javascript:void(0)" onclick="delete_message('<?php echo $message_id ?>')">
                                                            ...
                                                            <!-- <img class="injectable hw-18 mr-2" src="./assets_chat/media/heroicons/outline/trash.svg" alt="message delete"> -->
                    ...
                    <div class="chat-footer">
                        ...
                        <div style="display: none;" class="attachment">
                            ...
                            <div class="dropdown">
                                ...
                                <button class="btn btn-secondary btn-icon btn-minimal btn-sm" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    ...
                                    <!-- <img class="injectable hw-20" src="./assets_chat/media/heroicons/outline/plus-circle.svg" alt=""> -->
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a class="dropdown-item" href="#">
                                        ...
                                        <!-- <img class="injectable hw-20 mr-2" src="./assets_chat/media/heroicons/outline/photograph.svg" alt=""> -->
                                    ...
                                    <a class="dropdown-item" href="#">
                                        ...
                                        <!-- <img class="injectable hw-20 mr-2" src="./assets_chat/media/heroicons/outline/volume-up.svg" alt=""> -->
                                    ...
                                    <a class="dropdown-item" href="#">
                                        ...
                                        <!-- <img class="injectable hw-20 mr-2" src="./assets_chat/media/heroicons/outline/document.svg" alt=""> -->
                                    ...
                                    <a class="dropdown-item" href="#">
                                        ...
                                        <!-- <img class="injectable hw-20 mr-2" src="./assets_chat/media/heroicons/outline/user.svg" alt=""> -->
                                    ...
                                    <a class="dropdown-item" href="#">
                                        ...
                                        <!-- <img class="injectable hw-20 mr-2" src="./assets_chat/media/heroicons/outline/location-marker.svg" alt=""> -->
                                    ...
                                    <a class="dropdown-item" href="#">
                                        ...
                                        <!-- <img class="injectable hw-20 mr-2" src="./assets_chat/media/heroicons/outline/chart-square-bar.svg" alt=""> -->
                        ...
                        <div onclick="sendmessage()" ; class="btn btn-primary btn-icon send-icon rounded-circle text-light mb-1" role="button">
                            ...
                            <!-- <img src="./assets_chat/media/heroicons/outline/arrow-right.svg" alt="" class="injectable"> -->
                                ...
                                <ul class="nav justify-content-between align-items-center">
                                    ...
                                    <li class="nav-item list-inline-item">
                                        ...
                                        <a class="nav-link text-muted px-0" href="#" data-chat-info-close="">
                                            ...
                                            <!-- <img class="injectable hw-22" src="./assets_chat/media/heroicons/outline/x.svg" alt=""> -->
                        ...
                        <div class="hide-scrollbar flex-fill">
                            ...
                            <div class="text-center p-3">
                                ...
                                <div class="avatar avatar-xl mx-5 mb-3">
                                    ...
                                    <img class="avatar-img" src="assets_chat/media/avatar/2.png" alt="">
                                ...
                                <p class="text-muted d-flex align-items-center justify-content-center">
                                    ...
                                    <!-- <img class="injectable mr-1 hw-18" src="./assets_chat/media/heroicons/outline/location-marker.svg" alt=""> -->
                                ...
                                <div class="d-flex align-items-center justify-content-center">
                                    ...
                                    <div class="btn btn-outline-default btn-icon rounded-circle mx-1">
                                        ...
                                        <!-- <img class="injectable hw-20" src="./assets_chat/media/heroicons/outline/user-add.svg" alt=""> -->
                                    ...
                                    <div class="btn btn-primary btn-icon rounded-circle text-light mx-1">
                                        ...
                                        <!-- <img class="injectable hw-20" src="./assets_chat/media/heroicons/outline/heart.svg" alt=""> -->
                                    ...
                                    <div class="btn btn-danger btn-icon rounded-circle text-light mx-1">
                                        ...
                                        <!-- <img class="injectable hw-20" src="./assets_chat/media/heroicons/outline/ban.svg" alt=""> -->
                            ...
                            <div class="chat-info-group">
                                ...
                                <a class="chat-info-group-header" data-toggle="collapse" href="#profile-info" role="button" aria-expanded="true" aria-controls="profile-info">
                                    ...
                                    <!-- <img class="injectable text-muted hw-20" src="./assets_chat/media/heroicons/outline/information-circle.svg" alt=""> -->
                            ...
                            <div class="chat-info-group">
                                ...
                                <a class="chat-info-group-header" data-toggle="collapse" href="#shared-media" role="button" aria-expanded="true" aria-controls="shared-media">
                                    ...
                                    <!-- <img class="injectable text-muted hw-20" src="./assets_chat/media/heroicons/outline/photograph.svg" alt=""> -->
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-4 col-md-2 col-xl-4">
                                                ...
                                                <a href="#">
                                                    ...
                                                    <img src="assets_chat/media/shared-photos/01.jpg" class="img-fluid rounded border" alt="">
                                            ...
                                            <div class="col-4 col-md-2 col-xl-4">
                                                ...
                                                <a href="#">
                                                    ...
                                                    <img src="assets_chat/media/shared-photos/02.jpg" class="img-fluid rounded border" alt="">
                                            ...
                                            <div class="col-4 col-md-2 col-xl-4">
                                                ...
                                                <a href="#">
                                                    ...
                                                    <img src="assets_chat/media/shared-photos/03.jpg" class="img-fluid rounded border" alt="">
                            ...
                            <div class="chat-info-group">
                                ...
                                <a class="chat-info-group-header" data-toggle="collapse" href="#shared-files" role="button" aria-expanded="true" aria-controls="shared-files">
                                    ...
                                    <!-- <img class="injectable text-muted hw-20" src="./assets_chat/media/heroicons/outline/document.svg" alt=""> -->
                                            ...
                                            <li class="list-group-item">
                                                ...
                                                <div class="document">
                                                    ...
                                                    <div class="btn btn-primary btn-icon rounded-circle text-light mr-2">
                                                        ...
                                                        <!-- <img class="injectable hw-24" src="./assets_chat/media/heroicons/outline/document.svg" alt=""> -->
                                            ...
                                            <li class="list-group-item">
                                                ...
                                                <div class="document">
                                                    ...
                                                    <div class="btn btn-primary btn-icon rounded-circle text-light mr-2">
                                                        ...
                                                        <!-- <img class="injectable hw-24" src="./assets_chat/media/icons/excel-file.svg" alt=""> -->
                                            ...
                                            <li class="list-group-item">
                                                ...
                                                <div class="document">
                                                    ...
                                                    <div class="btn btn-primary btn-icon rounded-circle text-light mr-2">
                                                        ...
                                                        <!-- <img class="injectable hw-24" src="./assets_chat/media/icons/powerpoint-file.svg" alt=""> -->
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="avatar avatar-primary mr-2">
                                            ...
                                            <span>
                                                ...
                                                <!-- <img class="injectable hw-24" src="./assets_chat/media/heroicons/solid/phone-incoming.svg" alt=""> -->
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="avatar avatar-primary mr-2">
                                            ...
                                            <span>
                                                ...
                                                <!-- <img class="injectable hw-24" src="./assets_chat/media/heroicons/solid/phone-outgoing.svg" alt=""> -->
                                    ...
                                    <div class="d-flex flex-column align-items-center">
                                        ...
                                        <div class="d-flex mt-2">
                                            ...
                                            <div class="btn btn-primary btn-icon rounded-circle text-light mx-2">
                                                ...
                                                <!-- <img class="injectable hw-24" src="./assets_chat/media/heroicons/outline/chat.svg" alt=""> -->
                                            ...
                                            <div class="btn btn-success btn-icon rounded-circle text-light mx-2">
                                                ...
                                                <!-- <img class="injectable hw-24" src="./assets_chat/media/heroicons/outline/phone.svg" alt=""> -->
                                ...
                                <ul class="list-group list-group-flush">
                                    ...
                                    <li class="list-group-item">
                                        ...
                                        <div class="media align-items-center">
                                            ...
                                            <!-- <img class="injectable text-muted hw-20" src="./assets_chat/media/heroicons/outline/clock.svg" alt=""> -->
                                    ...
                                    <li class="list-group-item">
                                        ...
                                        <div class="media align-items-center">
                                            ...
                                            <!-- <img class="injectable text-muted hw-20" src="./assets_chat/media/heroicons/outline/calendar.svg" alt=""> -->
                                    ...
                                    <li class="list-group-item">
                                        ...
                                        <div class="media align-items-center">
                                            ...
                                            <!-- <img class="injectable text-muted hw-20" src="./assets_chat/media/heroicons/outline/phone.svg" alt=""> -->
                                    ...
                                    <li class="list-group-item">
                                        ...
                                        <div class="media align-items-center">
                                            ...
                                            <!-- <img class="injectable text-muted hw-20" src="./assets_chat/media/heroicons/outline/mail.svg" alt=""> -->
                                    ...
                                    <li class="list-group-item">
                                        ...
                                        <div class="media align-items-center">
                                            ...
                                            <!-- <img class="injectable text-muted hw-20" src="./assets_chat/media/heroicons/outline/globe.svg" alt=""> -->
                                    ...
                                    <li class="list-group-item">
                                        ...
                                        <div class="media align-items-center">
                                            ...
                                            <!-- <img class="injectable text-muted hw-20" src="./assets_chat/media/heroicons/outline/home.svg" alt=""> -->
                                ...
                                <ul class="list-group list-group-flush">
                                    ...
                                    <li class="list-group-item">
                                        ...
                                        <div class="media align-items-center">
                                            ...
                                            <!-- <img class="injectable text-muted hw-20" src="./assets_chat/media/icons/facebook.svg" alt=""> -->
                                    ...
                                    <li class="list-group-item">
                                        ...
                                        <div class="media align-items-center">
                                            ...
                                            <!-- <img class="injectable text-muted hw-20" src="./assets_chat/media/icons/twitter.svg" alt=""> -->
                                    ...
                                    <li class="list-group-item">
                                        ...
                                        <div class="media align-items-center">
                                            ...
                                            <!-- <img class="injectable text-muted hw-20" src="./assets_chat/media/icons/instagram.svg" alt=""> -->
                                    ...
                                    <li class="list-group-item">
                                        ...
                                        <div class="media align-items-center">
                                            ...
                                            <!-- <img class="injectable text-muted hw-20" src="./assets_chat/media/icons/linkedin.svg" alt=""> -->
        ...
        <div class="appbar">
            ...
            <div style="display: none;" class="appbar-wrapper hide-scrollbar">
                ...
                <div class="appbar-head">
                    ...
                    <!-- <img class="hw-20" src="./assets_chat/media/heroicons/outline/view-grid.svg" alt="" class="injectable hw-20"> -->
                ...
                <ul class="nav nav-minimal appbar-nav" id="appNavTab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        ...
                        <a class="nav-link" id="translator-tab" data-toggle="tab" href="#translator" role="tab" aria-controls="translator" aria-selected="true">
                            ...
                            <!-- <img class="injectable hw-22" src="./assets_chat/media/heroicons/outline/translate.svg" alt=""> -->
                    ...
                    <li class="nav-item" role="presentation">
                        ...
                        <a class="nav-link" id="notes-tab" data-toggle="tab" href="#notes" role="tab" aria-controls="notes" aria-selected="false">
                            ...
                            <!-- <img class="injectable hw-22" src="./assets_chat/media/heroicons/outline/collection.svg" alt=""> -->
                    ...
                    <li class="nav-item" role="presentation">
                        ...
                        <a class="nav-link" id="todo-tab" data-toggle="tab" href="#todo" role="tab" aria-controls="todo" aria-selected="false">
                            ...
                            <!-- <img class="injectable hw-22" src="./assets_chat/media/heroicons/outline/clipboard-check.svg" alt=""> -->
                    ...
                    <li class="nav-item" role="presentation">
                        ...
                        <a class="nav-link" id="quick-settings-tab" data-toggle="tab" href="#quick-settings" role="tab" aria-controls="quick-settings" aria-selected="false">
                            ...
                            <!-- <img class="injectable hw-22" src="./assets_chat/media/heroicons/outline/cog.svg" alt=""> -->
                        ...
                        <div class="d-flex flex-column justify-content-center text-center h-100 w-100">
                            ...
                            <div class="container">
                                ...
                                <div class="avatar avatar-lg mb-2">
                                    ...
                                    <img class="avatar-img" src="assets_chat/media/avatar/4.png" alt="">
                        ...
                        <div class="appnavbar-scrollable-wrapper">
                            ...
                            <div class="appnavbar-body">
                                ...
                                <div class="appnavbar-body-title">
                                    ...
                                    <img class="injetable hw-16 text-muted mx-1" src="http://frontendmatters.org/quicky/assets/media/heroicons/outline/arrow-right.svg" alt="">
                                    ...
                                    <li class="list-group-item">
                                        ...
                                        <div class="media">
                                            ...
                                            <div class="avatar avatar-online mr-2">
                                                ...
                                                <img src="assets_chat/media/avatar/1.png" alt="">
                            ...
                            <div class="col-12">
                                ...
                                <div class="d-flex justify-content-center align-items-center flex-column h-100">
                                    ...
                                    <div class="btn btn-success btn-icon rounded-circle text-light mb-3">
                                        ...
                                        <!-- <img class="injectable hw-24" src="./assets_chat/media/heroicons/outline/check.svg" alt=""> -->
                                    ...
                                    <li class="list-group-item">
                                        ...
                                        <div class="media">
                                            ...
                                            <div class="btn btn-primary btn-icon rounded-circle text-light mr-2">
                                                ...
                                                <!-- <img class="injectable hw-24" src="./assets_chat/media/heroicons/outline/user-add.svg" alt=""> -->
                                    ...
                                    <li class="list-group-item">
                                        ...
                                        <div class="media">
                                            ...
                                            <div class="btn btn-primary btn-icon rounded-circle text-light mr-2">
                                                ...
                                                <!-- <img class="injectable hw-24" src="./assets_chat/media/heroicons/outline/check-circle.svg" alt=""> -->
                                    ...
                                    <li class="list-group-item">
                                        ...
                                        <div class="media">
                                            ...
                                            <div class="btn btn-primary btn-icon rounded-circle text-light mr-2">
                                                ...
                                                <!-- <img class="injectable hw-24" src="./assets_chat/media/heroicons/outline/photograph.svg" alt=""> -->
    ...
    <script src="assets_chat/vendors/jquery/jquery-3.5.0.min.js"></script>

    <script src="assets_chat/vendors/bootstrap/bootstrap.bundle.min.js"></script>

    <script src="assets_chat/vendors/magnific-popup/jquery.magnific-popup.min.js"></script>

    <script src="assets_chat/vendors/svg-inject/svg-inject.min.js"></script>

    <script src="assets_chat/vendors/modal-stepes/modal-steps.min.js"></script>

    <script src="assets_chat/vendors/emojione/emojionearea.min.js"></script>

    <script src="assets_chat/js/app.js"></script>
    ...
    <script>
        ...
        function sendmessage() {
            ...
            $.ajax({
                ...
                url: "<?php echo base_url() . 'chat/replaymessage'; ?>",
                ...
                success: function(data) {
                    ...
                    if (data.status == 200) {
                        ...
                        url = '<?php echo base_url() . "assets/message_sent.mp3" ?>';
        ...
        setInterval(function() {
            ...
            $.ajax({
                ...
                url: "<?php echo base_url() . 'chat/get_all_messages';
                        ?>",
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data.status == 200) {
                        ...
                        alert('sorry message is not deleted');
