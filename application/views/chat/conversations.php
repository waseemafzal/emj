...
if(count($conversations)>0){
        ...
        <main class="main">
            ...
            <div style="display: none;" class="chats">
                            ...
                            <div class="appnavbar-body">
                                ...
                                <div class="appnavbar-body-title">
                                    ...
                                    <div class="dropdown mr-2">
                                        ...
                                        <button style="display: none;" class="btn btn-outline-default dropdown-toggle" type="button" data-notes-filter-list="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">All Notes</button>
